          ...
          <div class="mt-8 rounded-lg border border-gray-200 bg-gray-50 p-4">
            <div class="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
              <div class="flex flex-wrap items-center gap-x-6 gap-y-2 text-sm">
                ...
                <span v-if="isSubscribed" class="text-emerald-700 font-medium">已订�?/span>
              </div>
...
const details = {
  'ai-smart-monitor': {
    ...
    hero: '原有摄像头不换，加一�?AI 大脑，普通监控升级为 AI 智能监控�?,
    description: 'AgentHub AI 智能监控面向物业小区、工业园区、商业广场。客户只需在监控室电脑安装边缘端软件，原有摄像头通过 RTSP/ONVIF 接入，历史视频默认从客户 NVR 录像主机读取。平台负责配置、事件、通知�?AI 对话，不同事件可按负责人和通知通道分别路由�?,
    annualPrice: '¥9900',
    features: [
      { title: 'AI 环境卫生巡检', text: '自动识别公共区域垃圾、杂物、废弃物，输出卫生评分、抓拍图片、位置标注和扣分明细�? },
      { title: 'AI 高空抛物检�?, text: '24 小时检测高空抛物，结合连续帧分析、轨迹追踪和三层过滤，发现后立即报警�? },
      { title: 'AI 智能录像回查', text: '用自然语言查询历史录像或事件，按摄像头、时间段和场景检�?NVR 片段，生成事件时间线、视频片段和分析结论�? },
    ...
    workflow: ['下载安装 Windows 客户�?, '在本地工作台绑定 API Key', '配置摄像头接入和 NVR 品牌', '选择实时告警、录像回查、AI 找人等能力类�?, '接入微信、飞书、邮件、短信通知通道', '按事件配置负责人和通知规则', '通过后台或对话使�?AI 能力'],
    pricing: [],
    scenes: ['物业小区', '工业园区', '商业广场', '地下车库', '楼道', '垃圾房周�?, '学校操场', '消防通道'],
    values: ['不更换摄像头，旧设备直接利旧�?, '视频推理在本地，画面不上传云端�?, '不同事件自动发给对应负责人，减少人工转发�?, '告警、报告和追溯形成管理闭环�?],
    tech: [
      { label: '摄像头协�?, value: 'RTSP / ONVIF' },
      { label: '录像主机', value: '�?NVR 品牌适配' },
      { label: '推理位置', value: '客户边缘�? },
  ...
  'isp-smart-cs': {
    ...
    description: 'ISP 智能客服面向宽带运营商，平台负责理解客户意图并生成结构化指令，客户本地统一客户端连接内网业务系统执行查询、故障诊断、在线状态、光猫状态、续费、停复机、派工单�?ONU 管理等动作。通知通道默认覆盖全部业务能力�?,
    annualPrice: '¥4990',
    features: [
      { title: '账号查询', text: '查询宽带账号状态、套餐、余额、到期时间和使用情况�? },
      { title: '续费和停复机', text: '通过对话触发续费、停机、复机等高频业务动作�? },
      { title: '故障和在线诊�?, text: '查询用户是否在线、宽带故障原因、光猫在线状态、光功率、版本等关键信息�? },
      ...
      { title: '多系统适配', text: '支持凌风 LFRADIUS、秒开 OLT/TR069、智慧光�?IPTV，并可继续接入新系统�? },
    ],
      workflow: ['客户订阅能力', '下载安装 Windows 客户�?, '在本地工作台绑定 API Key', '填写计费、TR069、OLT、IPTV 等配�?, '配置统一业务通知通道', '在平台对话框处理宽带业务'],
    pricing: [],
    scenes: ['宽带营业�?, '装维客服', '网络运维值班', '物业宽带服务', '企业内网客服'],
